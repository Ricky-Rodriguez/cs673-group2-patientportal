      ...
      $.ajax({
        ...
        success: function(res) {
          ...
          for (var i=0; i < res.length; i++) {     
            ...
            '<a href = "https://sdpm-appointment-service.herokuapp.com/appointment/59/charts/4" download> <button type="submit" class="btn btn-primary chartBtn" >Chart Notes</button></a></li>'
